      ...
      <div className="bg-dark-blue-200 border-b border-solid border-dark-blue-100 px-6 py-3 overflow-auto flex justify-between">
        <Link to={"/"}>
          <button
            ...
            className="leading-8 heading-xs m-0 p-0 text-left bg-grayscale-0 hover:bg-grayscale-0 text-light-font"
          >
            {project.name}
          </button>
        </Link>
        ...
        <button
          className="font-light heading-xs m-0 p-0 bg-grayscale-0 hover:bg-grayscale-0 text-light-font hover:text-primary-200"
