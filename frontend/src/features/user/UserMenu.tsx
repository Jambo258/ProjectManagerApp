...
export const UserMenu = ({id, name}: UserMenuProps) => {
  ...
  return (        
    <section ref={menuRef} className="w-full px-3 sm:px-2 py-3.5 sm:py-4 sm:bg-dark-blue-100">
      ...
      {openMenu &&
      <section 
        className="flex flex-col bg-grayscale-100 fixed w-fit z-20 sm:left-14 sm:bottom-2 right-2 border-2 border-grayscale-200 shadow-md rounded divide-y divide-grayscale-200">
        <Modal 
